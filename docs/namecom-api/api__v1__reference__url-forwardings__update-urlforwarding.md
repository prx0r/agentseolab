...
````yaml put /core/v1/domains/{domainName}/url/forwarding/{host}
openapi: 3.1.0
info:
  contact:
  ...
  /core/v1/domains/{domainName}/url/forwarding/{host}:
    put:
      ...
      description: >-
        ...
        hours to fully propagate. **Deprecated.** Use [Update URL Forwarding by
        ID](/api/v1/reference/url-forwardings/update-urlforwarding-by-id)
        instead.
