...
# Domain Transfer In Status Change

> Sent when you have subscribed to the event on your account, and a domain transfer IN to name.com is processing.
...
````yaml webhook domainTransferStatusChange
openapi: 3.1.0
info:
  contact:
