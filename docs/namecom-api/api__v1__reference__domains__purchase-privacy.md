...
````yaml post /core/v1/domains/{domainName}:purchasePrivacy
openapi: 3.1.0
info:
  contact:
  ...
  /core/v1/domains/{domainName}:purchasePrivacy:
    post:
      ...
      description: >-
        ...
        protection. If it’s not yet active, this will both purchase and enable
        the service.  This is a billable action unless covered by a bundled
        privacy plan.
      ...
      responses:
        ...
        '409':
          description: >-
            Conflict - Idempotency key reused for a different request, or
            privacy protection already exists for this domain.
          content:
            application/json:
              schema:
