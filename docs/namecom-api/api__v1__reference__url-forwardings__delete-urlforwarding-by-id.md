...
````yaml delete /core/v1/urlforwarding/{domainName}/{id}
openapi: 3.1.0
info:
  contact:
...
paths:
  /core/v1/urlforwarding/{domainName}/{id}:
    delete:
      ...
      description: >-
        Removes a URL forwarding configuration by ID. The domain must be owned
        by the authenticated account. This operation cannot be undone.
