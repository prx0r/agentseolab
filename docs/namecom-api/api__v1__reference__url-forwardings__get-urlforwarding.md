...
````yaml get /core/v1/domains/{domainName}/url/forwarding/{host}
openapi: 3.1.0
info:
  contact:
  ...
  /core/v1/domains/{domainName}/url/forwarding/{host}:
    get:
      ...
      description: >-
        ...
        **Deprecated.** Use [Get URL Forwarding by
        ID](/api/v1/reference/url-forwardings/get-urlforwarding-by-id) instead.
