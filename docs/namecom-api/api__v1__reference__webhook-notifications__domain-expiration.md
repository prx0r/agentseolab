...
> Sent when you have subscribed to this event on your account, and a domain has expired and entered the post-expiry grace period. This notification is informational only.



## OpenAPI

````yaml webhook domainExpiration
openapi: 3.1.0
info:
  contact:
