...
````yaml delete /core/v1/domains/{domainName}/url/forwarding/{host}
openapi: 3.1.0
info:
  contact:
  ...
  /core/v1/domains/{domainName}/url/forwarding/{host}:
    delete:
      ...
      description: >-
        ...
        cannot be undone. **Deprecated.** Use [Delete URL Forwarding by
        ID](/api/v1/reference/url-forwardings/delete-urlforwarding-by-id)
        instead.
