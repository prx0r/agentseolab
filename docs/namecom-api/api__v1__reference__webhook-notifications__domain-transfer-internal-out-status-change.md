...
# Internal Transfer Out Status Change

> Sent when you have subscribed to the event on your account, and a name.com domain transfers out of your account.



## OpenAPI

````yaml webhook domainTransferInternalOutStatusChange
openapi: 3.1.0
info:
  contact:
