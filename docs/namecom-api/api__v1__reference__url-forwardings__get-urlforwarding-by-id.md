...
````yaml get /core/v1/urlforwarding/{domainName}/{id}
openapi: 3.1.0
info:
  contact:
...
paths:
  /core/v1/urlforwarding/{domainName}/{id}:
    get:
      ...
      description: >-
        Retrieves the details of a specific URL forwarding configuration by ID. 
        The domain must be owned by the authenticated account.
